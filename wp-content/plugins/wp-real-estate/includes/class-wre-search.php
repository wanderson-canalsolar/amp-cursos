...
class WRE_Search {
	...
	public function pre_get_posts( $q ) {
		...
		$search_radius[]    = $this->radius_meta_query();
	...
	/**
	 * Return a meta query for filtering by radius.
	 * @return array
	 */
	protected function radius_meta_query( $search_radius = '' ) {
		
		if( $search_radius == '' ) {
		if ( isset( $_GET['search_radius'] ) && ! empty( $_GET['search_radius'] ) ) {
